...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_BATCH_NORMALIZATION:
  ...
  case LayerParameter_LayerType_SOFTMAX_LOSS_WITH_DETAIL:
    return new SoftmaxWithLossDetailLayer<Dtype>(param);
