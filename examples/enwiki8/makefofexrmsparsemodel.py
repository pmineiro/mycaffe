...
# re-run kappa=0.25
# GLOG_minloglevel=5 PYTHONPATH=../../python python makefofexrmsparsemodel.py fofe_xrm_sparse_small_unigram_train `cat numlinesfofengram9 | perl -lane 'print int(0.9*$F[0])'` fofengram9.txt.gz histo9 fofexrmsparsemodel9
#    delta t      average   since average   since     example        learning
#                    loss    last   sigma    last     counter            rate
#      2.519      11.2876 11.2876  0.0106  0.0106        1500         0.99999
#      5.114      11.2830 11.2783  0.0149  0.0193        3000         0.99998
#      9.546      11.2676 11.2522  0.0328  0.0507        6000         0.99996
#     17.069      11.2148 11.1620  0.0963  0.1598       12000         0.99992
#     31.503      10.9973 10.7799  0.3593  0.6223       24000         0.99984
#     60.231       9.9278  8.8582  1.7050  3.0506       48000         0.99968
#    114.198       8.9327  7.9376  2.5768  3.4486       96000         0.99936
#    219.819       8.0354  7.1381  3.0323  3.4879      192000        0.998721
#    429.360       7.3423  6.6492  3.2449  3.4575      384000        0.997443
#    830.732       6.7747  6.2070  3.4608  3.6767      768000        0.994893
#   1677.793       6.3130  5.8513  3.6217  3.7827     1536000        0.989812
#   3736.613       5.9597  5.6064  3.7042  3.7867     3072000        0.979728
#   8610.922       5.6812  5.4027  3.7292  3.7542     6144000        0.959867
#  19466.793       5.4499  5.2186  3.7148  3.7003    12288000        0.921345
#  43881.516       5.2510  5.0522  3.6772  3.6396    24576000        0.848877
